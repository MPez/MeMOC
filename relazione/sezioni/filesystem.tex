...
\begin{tikzpicture}[%
  ...
  \node [root] {eserc.lab.01}
    child { node at (6,0) [selected] {eserc.lab.02}
    ...
    child { node at (3,-0.5) [optional] {instances}
    }
    child { node at (3,-0.9) [optional] {results}
    }
    child { node at (3,-1.3) [optional] {solutions}
    }
